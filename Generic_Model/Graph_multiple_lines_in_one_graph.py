...
def open_pickle(problem_name, run, directory, gens, load_model = None):
...
def plot_hypervolume(problem_name, run, directory, gens, model1 = None, model2 = None, model3 = None, model4 = None, model5 = None, model6 = None, model7 = None, model8 = None, model9 = None, model10 = None):
    ...
    if model3 != None:
        model3_values = get_hypervolume_values(problem_name, run, directory, gens, model3)
    ...
    if model4 != None:
        model4_values = get_hypervolume_values(problem_name, run, directory, gens, model4)
...
doc = plot_hypervolume(problem_name= "dtlz2", 
                       ...
                       gens =100,
                       model1 = 'Bestmodel_19-01-2024_test2_dtlz2',
                       model2 = 'Lastmodel_19-01-2024_test2_dtlz2',
                       model3 = None,
                       model4 = None,
                       )
