...
problem_bounds = {'dtlz1': {'val': [(0.0, 125), (0, 125.0), (0.0, 225.0)], 'mean': [67.8, 68.7, 135.7], 'std': [65.4, 64.3, 90.8]},
            ...
            'dtlz6': {'val': [(1.0, 6.5), (1.0, 6.5), (3.0, 9.5)], 'mean': [4.2, 4.2, 6.4], 'std': [2.84, 2.84, 3.12]},
            'dtlz7': {'val': [(0.0, 1.0), (0.0, 1.0), (12.0, 22.00)], 'mean': [0.5, 0.5, 18.3], 'std': [0.29, 0.29, 1.93]},
            'zdt1': {'val': [(0.0, 0.75), (2.5, 5.0)], 'mean': [0.5, 3.9], 'std': [0.29, 0.69]},
            'zdt2': {'val': [(0.0, 0.75), (4.0, 6.0)], 'mean': [0.5, 5.4], 'std': [0.29, 0.49]},
            'zdt3': {'val': [(0.0, 0.75), (2.0, 5.0)], 'mean': [0.5, 4.0], 'std': [0.29, 0.77]},
            'zdt4': {'val': [(0.0, 0.75), (30, 125)], 'mean': [0.5, 87.5], 'std': [0.29, 20.57]},
            'zdt6': {'val': [(0.5, 1.0), (7, 9.0)], 'mean': [0.9, 8.5], 'std': [0.14, 0,38]},
            'DF1': {'val': [(0.0, 0.75), (1.0, 5.0)], 'mean': [0.5, 3.68], 'std': [0.29, 0.94]},
            'DF2': {'val': [(0.0, 0.75), (0.5, 4.0)], 'mean': [0.5, 2.68], 'std': [0.29, 0.88]},
            'DF3': {'val': [(0.0, 0.75), (0.5, 5.0)], 'mean': [0.5, 2.38], 'std': [0.29, 1.05]},
            'DF4': {'val': [(0.0, 4.0), (2.0, 12.0)], 'mean': [1.59, 7.45], 'std': [1.28, 2.73]},
            'DF5': {'val': [(0.0, 4.0), (0.0, 4.0)], 'mean': [2.0, 2.0], 'std': [1.26, 1.26]},
            'DF6': {'val': [(20, 120), (20, 120)], 'mean': [77.6, 77.3], 'std': [21.32, 21.27]},
            ...
            'DF10': {'val': [(0.0, 3.0), (0.0, 1.5), (0.0, 1.5)], 'mean': [2.75, 1.02, 1.06], 'std': [4.31, 2.35, 2.52]},
            ...
            'DF14': {'val': [(0.75, 2.5), (0.0, 2.0), (0.0, 2.0)], 'mean': [1.83, 0.92, 0.92], 'std': [0.42, 0.60, 0.57]}}
