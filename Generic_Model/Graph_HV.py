...
def open_pickle(problem_name, run, directory, gens, load_model):
    ...
    if load_model == None:
        file = open(f"Results/{f'{directory}/Problem_{problem_name}_POP_size_20'}.pkl", "rb")
    else:
        file = open(f"Results/{f'{directory}/Problem_{problem_name}_POP_size_20_{load_model}'}.pkl", "rb")
