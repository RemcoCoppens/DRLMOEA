...
class NSGA_III_Learning:
    ...
    def multiple_runs(self, problem_name, problem_names, nr_of_runes, runs_per_problem, cycles, progressbar = False):
        ...
        for _ in range(cycles):
            for problem_name in problem_names:
                ...
                for i in range(10):
                        ...
                        self.hv_trace = []
                for idxrun in tqdm(range(1, runs_per_problem+1)) if progressbar else range(1, runs_per_problem+1):
                        print(problem_name)    
                        ...
                        if clipped_performance > self.agent.best_performance:
                            ...
                            self.agent.save_model(fname = f'Bestmodel_05-02-2024_{problem_names}.h5')


                        #Save last model
                        self.agent.save_model(fname = f'Lastmodel_05-02-2024_{problem_names}.h5')
...
if __name__ == '__main__':
    ...
    problem_name = 'dtlz2'
    problem_names = ['dtlz1', 'dtlz2', 'dtlz3', 'dtlz4', 'dtlz5']
    nr_of_runs = 2000
    runs_per_problem = 100
    cycles = nr_of_runs//(runs_per_problem*len(problem_names))
    ...
    nsga.multiple_runs(problem_name = problem_name, 
                       problem_names = problem_names, 
                       nr_of_runes=nr_of_runs, 
    ...
    print(performance)
    file = open(f"Results/NSGA-III_Learning/Lastmodel_05-02-2024_{problem_names}.pkl", "wb")
    pickle.dump(performance, file)
    file.close()
